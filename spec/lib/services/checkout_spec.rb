...
RSpec.describe Services::Checkout do
  ...
  context 'Add items multiple items to cart' do
    it 'returns the detailed_bill for three items in the cart' do
      expected_result = {
        order_items_summary: [
          { product_code: 'A', quantity: 1, unit_price: 30.0, discount: 0.0, total_price: 30.0 },
          { product_code: 'B', quantity: 1, unit_price: 20.0, discount: 0.0, total_price: 20.0},
          { product_code: 'C', quantity: 1, unit_price: 50.0, discount: 0, total_price: 50.0}
        ],
        cart_discount: 0.0,
    ...
    it 'returns the detailed_bill for five items in the cart' do
      expected_result = {
        order_items_summary: [
          { product_code: 'B', quantity: 2, unit_price: 20.0, discount: 5.0, total_price: 40.0 },
          { product_code: 'A', quantity: 3, unit_price: 30.0, discount: 15.0, total_price: 90.0 }
        ],
        cart_discount: 0.0,
    ...
    it 'returns the detailed_bill for seven items in the cart' do
      expected_result = {
        order_items_summary: [
          { product_code: 'C', quantity: 1, unit_price: 50.0, discount: 0.0, total_price: 50.0 },
          { product_code: 'B', quantity: 2, unit_price: 20.0, discount: 5.0, total_price: 40.0 },
          { product_code: 'A', quantity: 3, unit_price: 30.0, discount: 15.0, total_price: 90.0 },
          { product_code: 'D', quantity: 1, unit_price: 15.0, discount: 0.0, total_price: 15.0 }
        ],
        cart_discount: 20.0,
